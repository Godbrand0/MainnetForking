...
async function SwapEth() {
  ...
  const wethAdress = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
    ...
    console.log("user initial WETH balance", ethers.formatUnits(WETHbal.toString(), 18));
    ...
    console.log("user final WETH balance", ethers.formatUnits(WETHBalAfter.toString(), 18));
